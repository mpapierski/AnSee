...
void CAnSeeView::OnRButtonDown(wxEvent & ev)
{
	...
	menu.AppendMenu( MF_STRING, ID_FILE_OPEN, "Pak���� ����\t(Ctrl+&O)" );
	CAnSeeDoc* pDoc = GetDocument();
	if( pDoc->m_pSpr[pDoc->m_view] == NULL )
	{
		menu.AppendMenu( MF_GRAYED, ID_FILE_SAVE, "ASD���Ϸ� ����Ǯ��\t(Ctrl+&S)" );
		menu.AppendMenu( MF_GRAYED, ID_EDIT_COPY, "SPD�� BMP�� ����Ǯ��\t(Ctrl+&C)" );
		menu.AppendMenu( MF_GRAYED, ID_EDIT_PASTE, "PAK���� �����\t(Ctrl+&V)" );
		menu.AppendMenu( MF_GRAYED, ID_EDIT_CUT, "ASD���� �ٲ�ġ��\t(Ctrl+&X)" );
	}
	else
	{
		menu.AppendMenu( MF_STRING, ID_FILE_SAVE, "ASD���Ϸ� ����Ǯ��\t(Ctrl+&S)" );
		menu.AppendMenu( MF_STRING, ID_EDIT_COPY, "SPD�� BMP�� ����Ǯ��\t(Ctrl+&C)" );
		menu.AppendMenu( MF_STRING, ID_EDIT_PASTE, "PAK���� �����\t(Ctrl+&V)" );
		menu.AppendMenu( MF_STRING, ID_EDIT_CUT, "ASD���� �ٲ�ġ��\t(Ctrl+&X)" );
	}
	SetForegroundWindow();
...
void CAnSeeView::RefreshView()
{
	...
	if( pDoc->m_pSpr[pDoc->m_view] == NULL )
	{
		if( pDoc->m_cPathName != "" )
		{
			...
			status3.Format( "���Ͽ���" );
			status4.Format( "100%%" );
			status5.Format( "Pak���Ͽ� ������ �ֽ��ϴ�." );
			rt.top = 250;
			rt.bottom = 400;
			BufferDC.DrawText( "Pak���Ͽ� ������ �ֽ��ϴ�.", &rt, DT_CENTER );
		}
		else
		{
			status0.Format( "0/0" );
